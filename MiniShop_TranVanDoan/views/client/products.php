...
<div class="container my-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <select class="form-select form-select-sm" style="width: auto;" onchange="location.href='index.php?area=client&controller=product&action=index&sort='+this.value">
        ...
        <nav class="mt-4 d-flex justify-content-center">
            <ul class="pagination">
                <li class="page-item <?= $page <= 1 ? 'disabled' : '' ?>">
                    <a class="page-link" href="index.php?area=client&controller=product&action=index&sort=<?= $sort ?>&page=<?= $page - 1 ?>">‹</a>
                </li>
                <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                    <li class="page-item <?= $i == $page ? 'active' : '' ?>">
                        <a class="page-link" href="index.php?area=client&controller=product&action=index&sort=<?= $sort ?>&page=<?= $i ?>"><?= $i ?></a>
                    </li>
                <?php endfor; ?>
