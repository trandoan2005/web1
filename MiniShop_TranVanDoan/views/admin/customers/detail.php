...
<div class="card shadow-sm">
    <div class="card-header bg-info text-white">
        <h5 class="mb-0"><i class="bi bi-info-circle"></i> Chi tiết khách hàng</h5>
    </div>
    <div class="card-body">
        <table class="table table-bordered">
            <tbody>
                ...
                <tr>
                    <th class="table-light">Địa chỉ</th>
                    <td class="fw-bold text-primary"><?= htmlspecialchars($obj->address) ?></td>
                </tr>
                <tr>
